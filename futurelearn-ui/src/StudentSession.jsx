...
const StudentSession = ({ session, onLeave }) => {
    ...
    return (
        ...
        const mainLayout = { display:'flex', gap:'20px', padding:'40px', minHeight:'100vh', justifyContent:'center', alignItems:'center', position:'relative', zIndex:1 };
        const sessionCardFull = { width:'90%', maxWidth:'1100px', height:'80vh', display:'flex', flexDirection:'column', padding:'40px', backgroundColor:'rgba(255,255,255,0.85)', transition:'0.3s', borderRadius:'24px' };
        const sessionCardWithChat = { ...sessionCardFull, width:'65%' };
        const sideChatPanel = { width:'350px', height:'80vh', display:'flex', flexDirection:'column', backgroundColor:'rgba(255,255,255,0.95)', padding:'20px', animation:'slideInRight 0.3s', borderRadius:'24px' };
        const header = { display:'flex', justifyContent:'space-between', alignItems:'center', borderBottom:'1px solid #e2e8f0', paddingBottom:'20px' };
        const pinBadge = { backgroundColor:'#6d28d9', color:'white', padding:'8px 15px', borderRadius:'10px', fontWeight:'bold' };
        const contentArea = { flex:1, display:'flex', justifyContent:'center', alignItems:'center' };
        const waitingBox = { textAlign:'center' };
        const questionBox = { width:'100%', padding:'40px', backgroundColor:'white', borderRadius:'25px', boxShadow:'0 10px 30px rgba(0,0,0,0.05)', border:'1px solid #f1f5f9' };
        ...
        const reactionBtn = { width:'45px', height:'45px', borderRadius:'50%', border:'none', backgroundColor:'white', cursor:'pointer', fontSize:'20px', display:'flex', justifyContent:'center', alignItems:'center', boxShadow:'0 4px 6px rgba(0,0,0,0.05)', transition:'0.2s' };
        ...
        const chatInput = { flex:1, padding:'12px', borderRadius:'10px', border:'1px solid #e2e8f0', outline:'none' };
        const sendBtn = { backgroundColor:'#6d28d9', color:'white', border:'none', borderRadius:'10px', width:'45px', height:'45px', cursor:'pointer', display:'flex', justifyContent:'center', alignItems:'center' };
        const chatToggleBtn = { backgroundColor:'#6d28d9', color:'white', border:'none', borderRadius:'15px', padding:'12px 20px', cursor:'pointer', fontWeight:'bold', display:'flex', alignItems:'center', gap:'10px', boxShadow:'0 4px 12px rgba(109,40,217,0.3)', transition:'0.2s' };

        // --- STYLES DES ONGLETS (NOUVEAU) ---
        const tabHeader = { display:'flex', justifyContent:'space-between', alignItems:'center', borderBottom:'1px solid #eee', paddingBottom:'10px', marginBottom:'15px' };
        const tabInactive = { fontSize:'14px', color:'#94a3b8', cursor:'pointer', padding:'5px 10px', borderRadius:'8px', fontWeight:'500' };
